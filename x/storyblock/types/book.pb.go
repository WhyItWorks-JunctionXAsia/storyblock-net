...
var fileDescriptor_88a881896bcd008a = []byte{
	...
	0xc9, 0x17, 0x42, 0x12, 0xd6, 0x43, 0x30, 0x95, 0xd6, 0x31, 0x72, 0xb1, 0x38, 0xe5, 0xe7, 0x67,
	...
	,
}
...
func (m *Book) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Keplr) > 0 {
		i -= len(m.Keplr)
		copy(dAtA[i:], m.Keplr)
		i = encodeVarintBook(dAtA, i, uint64(len(m.Keplr)))
		i--
		dAtA[i] = 0x1a
	}
	if m.Id != 0 {
