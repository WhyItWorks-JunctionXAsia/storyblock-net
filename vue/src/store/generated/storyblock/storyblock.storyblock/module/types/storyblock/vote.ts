...
export const Vote = {
  encode(message: Vote, writer: Writer = Writer.create()): Writer {
    ...
    if (message.createdHeight !== "") {
      writer.uint32(42).string(message.createdHeight);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          break;
        case 5:
          message.createdHeight = reader.string();
          break;
        default:
  ...
  fromJSON(object: any): Vote {
    ...
    if (object.createdHeight !== undefined && object.createdHeight !== null) {
      message.createdHeight = String(object.createdHeight);
    } else {
      message.createdHeight = "";
    }
    return message;
  },
  ...
  toJSON(message: Vote): unknown {
    ...
    message.createdHeight !== undefined &&
