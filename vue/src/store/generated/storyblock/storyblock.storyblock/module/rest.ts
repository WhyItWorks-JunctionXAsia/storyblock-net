...
export interface StoryblockBook {
  creator?: string;
...
export type StoryblockMsgDoVoteResponse = object;

/**
 * Params defines the parameters for the module.
 */
export type StoryblockParams = object;

export interface StoryblockQueryBooksResponse {
  Book?: StoryblockBook[];
 ...
 */
export interface StoryblockQueryParamsResponse {
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/storyblock/storyblock/books
   */
  queryBooks = (
    query?: {
    ...
    this.request<StoryblockQueryBooksResponse, RpcStatus>({
      path: `/storyblock/storyblock/books`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/storyblock/storyblock/params
   */
