...
import StoryblockStoryblockStoryblock from './storyblock/storyblock.storyblock'
...
export default { 
  ...
  StoryblockStoryblockStoryblock: load(StoryblockStoryblockStoryblock, 'storyblock.storyblock'),
